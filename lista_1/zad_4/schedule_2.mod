...
s.t. ExcludeDays:
    (sum{g in GroupNum, s in Subject: groupDay[s, g] = 'Wednesday' or groupDay[s, g] = 'Friday'} chosenGroup[s, g]) = 0;

s.t. MinimumRating{g in GroupNum, s in Subject : groupRating[s, g] < 5}:
    chosenGroup[s, g] = 0;
